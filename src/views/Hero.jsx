...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="triangle" hiddenMobile width={48} stroke={colors.orange} left="8%" top="20%" />
      ...
      <SVG icon="circle" hiddenMobile width={24} fill={colors['pink-lightest']} left="5%" top="70%" />
